...
<html lang="ru">
	<head>
		...
		<title>Congratulations! Your form is accepted!</title>
	...
	<body>
		<div class="wrapper">
			<div class="block_success">
				<h2 style="text-transform: uppercase;">Congratulations! Your form is accepted!</h2>
				<p class="success">
					Our manager will contact you soon!
				</p>
				<h3 class="success">
					Please check the correctness of the entered information.
				</h3>
				<!--<div class="success">
					<ul class="list_info">
				...
				<p class="fail success">If you made a mistake while filling out the form, please <a href="javascript: history.back(-1);">fill out the form again</a></p>

				<div class="back_btn">
                <a href="index.html" class="back_btn_link">BACK</a>
            </div>
			</div>
		</div>
	</body>
